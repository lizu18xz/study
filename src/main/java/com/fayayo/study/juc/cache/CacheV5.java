 ...
 */
public class CacheV5<A,V> implements Computable<A,V>{
    ...
    public CacheV5(Computable<A, V> computable) {
        this.c = computable;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        CacheV5<String,Integer> cache=new CacheV5<>(new ExpensiveFunction());
